            ...
            <section class="col-6 offset-3">
                <form action="{{route('slider.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <section class="form-group">
                        ...
                        <textarea class="form-control" id="caption" name="caption" style="resize: none; height: 75px"></textarea>
                    </section>
                    <section class="form-group">
                        <label for="alter">alter:</label>
                        <textarea class="form-control" id="alter" name="alter" style="resize: none; height: 50px"></textarea>
                    </section>
                    <section class="form-group">
